...
import ru.guildforge.tasks.PlatformScheduler;
...
public class GuildForge extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        this.taskScheduler = PlatformScheduler.create(this);
        ...
        getLogger().info("§aGuildForge v" + getDescription().getVersion() + " успешно запущен!");
    }
    ...
    public PlatformScheduler getTaskScheduler() { return taskScheduler; }
